...
@section('content')
    <div class="flex flex-col justify-center items-center pt-24 lg:pt-20 gap-4">
        ...
        @else
            <section
                ...
                <img src="{{ asset('assets/vector/undraw_empty_4zx0 (1).svg') }}" class="bg-[#8a6b24] px-2 py-2 rounded-full w-68 md:w-72 lg:w-80" alt="Empty Vector">
                ...
                <a href="{{ route('general.products.index') }}" class="text-amber-700 active:text-amber-700 transition-all hover:text-amber-600 font-medium">Lihat Products</a>
            </section>   
        @endif
    </div>
@endsection
