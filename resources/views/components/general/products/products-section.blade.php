<section class="flex flex-col justify-center items-center pt-24 lg:pt-16 gap-4">
    ...
    <form x-data="{ value: {{ $search ?? '' }} }" method="GET" class="max-w-sm sm:max-w-lg md:max-w-xl lg:max-w-2xl relative mx-12 w-full">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" name="search" value="{{ $search ?? '' }}" autocomplete="off"
            ...
            <i class="ph ph-x text-lg absolute top-4 right-26 cursor-pointer hover:text-[#bd8c22]"></i>
            <button type="submit"
